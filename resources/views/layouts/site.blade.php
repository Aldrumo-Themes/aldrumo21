...
<html>
    <head>
        @include('Aldrumo21::partials.head', [
            'title' => (!empty($page) && $page->title !== 'Home' ? $page->title . ' - ' : '') . config('app.name')
        ])

        @include('Aldrumo21::partials.og', [
            'title' => config('app.name') . (!empty($page) ? ' - ' . $page->title : ''),
            'desc'  => strip_tags($contentBlocks->first()->content ?? ''),
            'card'  => '/aldrumo/aldrumo21/meta/card.png'
        ])
    </head>
    <body class="bg-gray-100">
        <header class="z-30 w-full px-2 py-4 bg-gray-900 sm:px-4 shadow">
            <div class="container flex items-center justify-between mx-auto">
                <a href="/" title="Aldrumo21 Home Page" class="flex items-center">
                    <svg class="w-auto h-14 bg-white rounded" viewBox="0 0 816 670" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="w-auto h-8 ml-4" viewBox="0 0 1371 218" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M129.27 3.82456H84.9053L0 214.175H51.5041L67.0573 172.105H147.118L162.671 214.175H214.175L129.27 3.82456ZM130.8 130.035H83.3754L106.833 68.8421H107.343L130.8 130.035Z" fill="#fff"/>
                        <path d="M270.315 3.82456H222.38V214.175H342.727V172.105H270.315V3.82456Z" fill="#fff"/>
                        <path d="M366.548 3.82456V214.175H427.486C485.365 214.175 533.554 170.32 533.554 108.873C533.554 47.6795 485.11 3.82456 427.486 3.82456H366.548ZM414.483 171.34V46.6597H421.877C457.573 46.6597 481.795 73.9415 481.795 109.127C481.54 144.313 457.318 171.34 421.877 171.34H414.483Z" fill="#fff"/>
                        <path d="M554.788 3.82456V214.175H602.723V131.055L666.976 214.175H727.914L655.502 127.23C681.254 119.071 698.592 97.9088 698.592 66.2924C698.592 24.9871 669.015 3.82456 630.005 3.82456H554.788ZM602.723 97.1439V42.0702H608.332C626.435 42.0702 648.108 43.345 648.108 69.607C648.108 95.869 626.435 97.1439 608.332 97.1439H602.723Z" fill="#fff"/>
                        <path d="M898.953 3.82456H851.019V125.446C851.019 160.632 840.31 170.83 816.853 170.83C793.395 170.83 782.687 160.632 782.687 125.446V3.82456H734.752V139.469C734.752 191.483 763.309 218 816.853 218C870.397 218 898.953 191.483 898.953 139.469V3.82456Z" fill="#fff"/>
                        <path d="M1100.93 214.175H1148.86L1129.99 3.82456H1079L1032.34 125.191L985.679 3.82456H934.685L915.817 214.175H963.752L973.696 89.4947H974.97L1018.06 212.901H1046.62L1089.71 89.4947H1090.98L1100.93 214.175Z" fill="#fff"/>
                        <path d="M1158.88 108.873C1158.88 170.32 1202.73 218 1264.95 218C1325.37 218 1370.76 170.32 1370.76 108.873C1370.76 47.4246 1323.33 0 1264.95 0C1207.07 0 1158.88 47.4246 1158.88 108.873ZM1210.64 108.873C1210.64 77.5111 1227.98 46.1497 1264.95 46.1497C1302.17 46.1497 1319 77.5111 1319 108.873C1319 140.234 1303.19 171.595 1264.95 171.595C1225.68 171.595 1210.64 140.234 1210.64 108.873Z" fill="#fff"/>
                    </svg>
                    <span class="sr-only">Aldrumo</span>
                </a>
                <div class="flex items-center space-x-1">
                    <div class="hidden space-x-1 md:inline-flex">
                        <a href="#" class="btn btn-sm btn-light-link">Features</a>
                        <a href="#" class="btn btn-sm btn-light-link">Pricing</a>
                        <a href="#" class="btn btn-sm btn-light-link">Blog</a>
                        <a href="#" class="btn btn-sm btn-light-link">Company</a>
                        <a href="#" class="btn btn-sm btn-light-link">Sign in</a>
                    </div>

                    <a href="#" class="btn btn-sm btn-light">Get Started</a>

                    <div class="inline-flex md:hidden" x-data="{ open: false }">
                        <button class="flex-none px-2 btn btn-light-link btn-sm" @click="open = true">
                            <svg
                        ...
                        <div class="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 pb-4 m-2 space-y-3 bg-gray-900 rounded shadow" x-show.transition="open" @click.away="open = false" x-cloak>
                            <button class="self-end flex-none px-2 ml-2 btn btn-light-link btn-icon" @click="open = false">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                            ...
                            <a href="#" class="w-full btn btn-light-link">Features</a>
                            <a href="#" class="w-full btn btn-light-link">Pricing</a>
                            <a href="#" class="w-full btn btn-light-link">Blog</a>
                            <a href="#" class="w-full btn btn-light-link">Company</a>
                            <a href="#" class="w-full btn btn-light-link">Sign in</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="bg-white">
            <div class="container flex flex-col items-center justify-between px-4 py-12 mx-auto md:flex-row bg-white">
                <p class="mb-8 text-sm text-center text-gray-700 md:text-left md:mb-0">© Copyright {{ date('Y') }} Aldrumo21. All Rights Reserved.</p>
        ...
        <script src="/aldrumo/aldrumo21/js/site.js"></script>
    </body>
</html>
